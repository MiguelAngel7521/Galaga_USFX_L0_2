...
AGalaga_USFX_L0_2Projectile::AGalaga_USFX_L0_2Projectile() 
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &AGalaga_USFX_L0_2Projectile::OnHit);		// set up a notification for when this component hits something
